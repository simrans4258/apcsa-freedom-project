...
## Choosing Tool and Project Idea
As with the tradition of SEP goes, we of course have a new Freedom Project to do. However, unlike the previous years, where we were limited by what we were learning in the year, this time Freedom really **is** freedom, as we can do whatever we want for our projects this year with any tool of our choosing. This is great for me, as I've *always* wanted to make my own game, specifically a visual novel, and since I already have some familiarity with Unity thanks to Game Academy, I decided to lean on those two options for my project.
...
## Skills
Of course, while learning my tool, I ended up learning a couple of skills along the way. Here are a few.

### Re-learning things you already know
Considering I technically got a higher advantage as I learned my tool earlier than others, I ended up having to relearn **a lot** of the things I already knew, either because I forgot them or needed to practice some of the coding I did before. It ended up being rather beneficial to me, as I managed to go deeper into the topics I already know, and I learned a lot more thanks to that. My [learning log](/tool/learning-log.md) helped me keep track of what I need to do for my project, so that's quite good!

### Discover more things for the project
I also figured out it would be beneficial for me to learn more stuff about Unity and C# (which is the language Unity uses), as I felt like I needed to learn more for my project as I was making a visual novel, which is something that I hadn't learned in the Summer Game Academy. I ended up looking into and saving a lot of tutorials on how to make visual novels on Unity, and surprisingly some concepts look easy to learn, like making more complex text boxes or scene transitions for example. Of course there's *a lot* to learn when trying to make something like that on Unity, but hey, it's good to learn something new! Overall, I had a good time re-learning Unity and getting started on my project, but I know there's a lot more to go!
